        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    DeliveryEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    ...
                    DeliveryPostcode = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    PaymentTokenId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    PaymentBrand = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    PaymentLast4 = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderRequests", x => new { x.UserId, x.Key });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderRequests_ExpiresAt",
                table: "OrderRequests",
                column: "ExpiresAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_GroupId_IsDeleted",
                table: "Products",
